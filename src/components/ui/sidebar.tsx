...
>(({ className, ...props }, ref) => {
  ...
  return (
    <button
      ...
      className={cn(
        "group-data-[side=left]:-right-4 group-data-[side=right]:left-0 hidden after:left-1/2 z-20 absolute after:absolute inset-y-0 after:inset-y-0 sm:flex hover:after:bg-sidebar-border w-4 after:w-[2px] transition-all -translate-x-1/2 ease-linear",
