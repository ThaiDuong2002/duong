...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Action
    ref={ref}
    className={cn(
      "group-[.destructive]:hover:bg-destructive group-[.destructive]:hover:text-destructive-foreground group-[.destructive]:focus:ring-destructive inline-flex justify-center items-center bg-transparent hover:bg-secondary disabled:opacity-50 px-3 border group-[.destructive]:hover:border-destructive/30 group-[.destructive]:border-muted/40 rounded-md focus:outline-none focus:ring-2 focus:ring-ring ring-offset-background focus:ring-offset-2 h-8 font-medium text-sm transition-colors disabled:pointer-events-none shrink-0",
      className
    )}
    {...props}
  />
...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Close
    ref={ref}
    className={cn(
      "group-[.destructive]:hover:text-red-50 group-[.destructive]:focus:ring-red-400 group-[.destructive]:text-red-300 top-2 right-2 absolute opacity-0 group-hover:opacity-100 focus:opacity-100 p-1 rounded-md focus:outline-none focus:ring-2 group-[.destructive]:focus:ring-offset-red-600 text-foreground/50 hover:text-foreground transition-opacity",
      className
    )}
    toast-close=""
    {...props}
